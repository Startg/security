...
return 'گروه در لیست مدیریتی ربات موجود میباشد'..msg_caption
  end
end
...
if matches[1] == "pin" or matches[1] == "سنجاق پیام" and is_mod(msg) and msg.reply_id then
...
if matches[1] == "setowner" or matches[1] == "صاحب گروه" and is_admin(msg) then
...
if matches[1] == "remowner" or matches[1] == "حذف صاحب گروه" and is_admin(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if matches[1] == "promote" or matches[1] == "کمک مدیر" and is_owner(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if matches[1] == "demote" or matches[1] == "حذف کمک مدیر" and is_owner(msg) then
if not matches[2] and msg.reply_id then
 tdcli_function ({
      ID = "GetMessage",
      chat_id_= msg.to.id,
...
if matches[2] == "markdown" or
matches[2] == "شیشه ای" then
return lock_markdown(msg, data, target)
end
if matches[2] == "webpage" or
matches[2] == "وب" then
return lock_webpage(msg, data, target)
end
if matches[2] == "pin" or
matches[2] == "سنجاق" and is_owner(msg) then
return lock_pin(msg, data, target)
end
end

if matches[1] == "unlock" or
matches[1] == "بازکردن" and is_mod(msg) then
local target = msg.to.id
if matches[2] == "link" or
matches[2] == "لینک" then
...
if matches[1] == "mute" or
matches[1] == "بیصدا کردن" and is_mod(msg) then
local target = msg.to.id
if matches[2] == "all" or
matches[2] == "همه" then
...
if matches[2] == "text" or
matches[2] == "تکست" then
return mute_text(msg ,data, target)
end
if matches[2] == "photo" or
matches[2] == "عکس" then
return mute_photo(msg ,data, target)
end
if matches[2] == "video" or
matches[2] == "ویدیو" then
return mute_video(msg ,data, target)
end
if matches[2] == "audio" or
matches[2] == "صدا" then
return mute_audio(msg ,data, target)
end
if matches[2] == "voice" or
matches[2] == "ویس" then
return mute_voice(msg ,data, target)
end
if matches[2] == "sticker" or
matches[2] == "استیکر" then
return mute_sticker(msg ,data, target)
end
if matches[2] == "contact" or
matches[2] == "مخاطب" then
return mute_contact(msg ,data, target)
end
if matches[2] == "forward" or
matches[2] == "فوروارد" then
return mute_forward(msg ,data, target)
end
if matches[2] == "location" or
matches[2] == "مکان" then
return mute_location(msg ,data, target)
end
if matches[2] == "document" or
matches[2] == "فایل" then
return mute_document(msg ,data, target)
end
if matches[2] == "tgservice" or
matches[2] == "سرویس تلگرام" then
return mute_tgservice(msg ,data, target)
end
if matches[2] == "inline" or
matches[2] == "اینلاین" then
return mute_inline(msg ,data, target)
end
if matches[2] == "game" or
matches[2] == "بازی" then
return mute_game(msg ,data, target)
end
if matches[2] == "keyboard" or
matches[2] == "کیبورد" then
return mute_keyboard(msg ,data, target)
end
end

if matches[1] == "unmute" or
matches[1] == "باصدا کردن" and is_mod(msg) then
local target = msg.to.id
if matches[2] == "all" or
matches[2] == "همه" then
...
if matches[1] == "res" or
matches[1] == "رس" and matches[2] and is_mod(msg) then
    tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.to.id,username=matches[2],cmd="res"})
  end
if matches[1] == "whois" or
matches[1] == "چه کسی" and matches[2] and is_mod(msg) then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.to.id,user_id=matches[2],cmd="whois"})
  end
  if matches[1] == 'setflood' or
matches[1] == 'تنظیم فلود' and is_mod(msg) then
    ...
    return "_Group_ *flood* _sensitivity has been set to :_ *[ "..matches[2].." ]*"
		...
		if matches[1]:lower() == 'clean' or
matches[1] == 'پاک کردن' and is_owner(msg) then
			if matches[2] == 'mods' or
matches[2] == 'کمک مدیر' then
	...
	if matches[1] == "filterlist" or
matches[1] == "لیست فیلتر" and is_mod(msg)  then
	  local flist = redis:smembers('filters:'..msg.chat_id_)
		...
		text = '*Filtered Words List :*\n\n'
		 ...
		 tdcli.sendMessage(msg.chat_id_, msg.id_, 1, text, 1 , 'md')
			...
			if matches[2] == 'rules' or
matches[2] == 'قوانین' then
				if not data[tostring(chat)]['rules'] then
            if not lang then
			...
			if matches[2] == 'welcome' or
matches[2] == 'ولکام' then
			...
			if matches[2] == 'about' or
matches[2] == 'درباره' then
   ...
   tdcli.changeChannelAbout(chat, "", dl_cb, nil)
		...
		if matches[1]:lower() == 'clean' or
matches[1] == 'پاک کردن'  and is_admin(msg) then
			if matches[2] == 'owners' or
matches[2] == 'صاحبان گروه' then
...
if matches[1] == "setname" or
matches[1] == "تنظیم نام" and matches[2] and is_mod(msg) then
local gp_name = matches[2]
tdcli.changeChatTitle(chat, gp_name, dl_cb, nil)
end
  if matches[1] == "setabout" or
matches[1] == "تنظیم درباره" and matches[2] and is_mod(msg) then
  ...
  if matches[1] == "about" or
matches[1] == "درباره" and msg.to.type == "chat" then
 if not data[tostring(chat)]['about'] then
     if not lang then
  ...
  if matches[1] == 'filter' or
matches[1] == 'فیلتر' and is_mod(msg) then
    return filter_word(msg, matches[2])
  end
  if matches[1] == 'unfilter' or
matches[1] == 'حذف فیلتر' and is_mod(msg) then
...
if matches[1] == "settings" or
matches[1] == "تنظیمات" then
return group_settings(msg, target)
end
if matches[1] == "mutelist" or
matches[1] == "لیست بیصداها" then
return mutes(msg, target)
end
if matches[1] == "modlist" or
matches[1] == "لیست کمک مدیران" then
return modlist(msg)
end
if matches[1] == "ownerlist" or
matches[1] == "لیست صاحب گروه" and is_owner(msg) then
return ownerlist(msg)
end

if matches[1] == "setlang" or
matches[1] == "تنظیم زبان" and is_owner(msg) then
   if matches[2] == "en" or
matches[2] == "انگلیسی" then
local hash = "gp_lang:"..msg.to.id
local lang = redis:get(hash)
 redis:del(hash)
return "_Group Language Set To:_ EN"
  elseif matches[2] == "fa" or
matches[2] == "فاریی" then
redis:set(hash, true)
...
/unpin
—〰〰〰〰〰〰〰〰〰〰〰〰
برای تنظیم خوشآمدگویی بصورت دلخواه به صورت زیر عمل کنید:
...
--------------------- Welcome -----------------------
	if matches[1] == "welcome" or
matches[1] == "ولکام" and is_mod(msg) then
		if matches[2] == "enable" or
matches[2] == "فعال" then
       ...
       elseif lang then
		...
		if matches[2] == "disable" or
matches[2] == "غیرفعال" then
			welcome = data[tostring(chat)]['settings']['welcome']
			if welcome == "no" then
      if not lang then
	...
	if matches[1] == "setwelcome" or
matches[1] == "تنظیم ولکام" and matches[2] and is_mod(msg) then
